...
!==========================Added input for SPI model===========================================
  ...
  call MPI_PACK (start_PFB_ts,               1,    MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr) 
  call MPI_PACK (vert_FB_gain,               3,    MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  call MPI_PACK (rad_FB_gain,                3,    MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr) 
  call MPI_PACK (pos_FB_tact,                1,    MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr) 
...
!==========================Added input for SPI model===========================================
  ...
  call MPI_UNPACK(buffer,bufsize,position,start_PFB_ts,           1,    MPI_REAL8,MPI_COMM_WORLD,ierr) 
  call MPI_UNPACK(buffer,bufsize,position,vert_FB_gain,           3,    MPI_REAL8,MPI_COMM_WORLD,ierr)
  call MPI_UNPACK(buffer,bufsize,position,rad_FB_gain,            3,    MPI_REAL8,MPI_COMM_WORLD,ierr) 
  call MPI_UNPACK(buffer,bufsize,position,pos_FB_tact,            1,    MPI_REAL8,MPI_COMM_WORLD,ierr) 
