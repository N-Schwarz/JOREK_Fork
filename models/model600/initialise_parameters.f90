...
namelist /in1/  tstep, nstep, tstep_n, nstep_n,                     &
                ...
                gamma_rel, re_initialize, re_gauss_width,           &
                re_gauss_origin, re_gauss_fact,  vpar_re_sign,      &
                re_trit_seed, re_compt_seed, re_sec_source,         &
                re_adv_fact, Dre_par, Dre_iso, Dre_num,             &
                initial_re_current_fraction, impdens_init,          &
